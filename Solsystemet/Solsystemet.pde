...
import g4p_controls.*;
int inputDay, inputMonth, inputYear, dayNumber, value = 0, speed=0;



Stjerne sun=new Stjerne();
//De nedestående planerters størelser er divideret med 400
Planet mercury=new Planet(88, #88878a, 57, 6, 9); //afstand fra solen 1:1 i millioner af km
Planet venus=new Planet(243, #ff952b, 108, 15,13);//afstand fra solen 1:1 i millioner af km
Planet earth=new Planet(365, #0000ff, 149, 16,0);//afstand fra solen 1:1 i millioner af km
...
Planet jupiter=new Planet(4330, #cf7923, 312, 139,659);//afstand fra solen 1:2,5 i millioner af km
...
Planet neptune=new Planet(60152, #0095ff, 647, 49,17277);//afstand fra solen 1:7 i millioner af km Kilde https://www.nasa.gov/wp-content/uploads/2015/01/yoss_act1.pdf
