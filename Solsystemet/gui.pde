...
public void button9_click1(GButton source, GEvent event) { //_CODE_:button9:585443:
  ...
  txaEvent.appendText("5. Merkur er opkaldt efter den romerske budbringergud, som også var gud for handel og profit.");
  ...
  txaEvent.appendText("kilde: https://science.nasa.gov/mercury/facts/");
...
public void button10_click1(GButton source, GEvent event) { //_CODE_:button10:402944:
  ...
  txaEvent.appendText("5. Venus er opkaldt efter den romerske gudinde for kærlighed og skønhed.");
  
  txaEvent.appendText("kilde: https://science.nasa.gov/venus/venus-facts/");
...
public void button15_click1(GButton source, GEvent event) { //_CODE_:button15:964870:
  ...
  txaEvent.setText("");
    ...
    txaEvent.appendText("Generel informaton om uranus:");
    txaEvent.appendText("Uranus er en af de 3 planeter med ringe rundt om sig.");
    txaEvent.appendText("Uranus er den syvende planet fra Solen.");
    txaEvent.appendText("Uranus er den første planet fundet ved hjælp af et teleskop og blev opdaget i 1781.");
txaEvent.appendText("planeten blev opkaldt efter Uranus, den græske himmelgud.");
  txaEvent.appendText("Sjove fakta om Uranus:");
...
public void createGUI() {
  ...
  txaEvent3 = new GTextArea(this, 385, 361, 95, 60, G4P.SCROLLBARS_NONE);
  txaEvent3.setText("måned: 1");
  ...
  txaEvent4 = new GTextArea(this, 386, 424, 95, 60, G4P.SCROLLBARS_NONE);
  ...
  txaEvent5 = new GTextArea(this, 385, 481, 95, 60, G4P.SCROLLBARS_NONE);
  txaEvent5.setText("dage i sek:0");
